...
public class cdcGdPhotoAttach {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource<String> mySqlSource = MySqlSource.<String>builder()
                ...
                .databaseList("obei_store_goods").tableList("obei_store_goods.t_gd_photo_attach")
        ...
        env.getCheckpointConfig().setCheckpointStorage("hdfs://mycluster/checkpoint/cdcGdPhotoAttach");
        ...
        //FlinkRebalancePartitioner<Object> objectFlinkRebalancePartitioner = new FlinkRebalancePartitioner<>();
